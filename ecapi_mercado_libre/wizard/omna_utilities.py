...
class OmnaUtilities(models.TransientModel):
    ...
    def native_prestashop_api(self):
        pass
        # prestashop_base_url = self.env['ir.config_parameter'].sudo().get_param("ecapi_mercado_libre.prestashop_base_url", default='https://qa.futurevisions.com.pe')
        # prestashop_ws_key = self.env['ir.config_parameter'].sudo().get_param("ecapi_mercado_libre.prestashop_ws_key")
