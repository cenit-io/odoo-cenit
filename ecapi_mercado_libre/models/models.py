...
class OmnaIntegration(models.Model):
    ...
    def _get_logo(self, channel):
        ...
        if 'Lazada' in channel:
            logo = modules.get_module_resource('ecapi_mercado_libre', 'static/src/img', 'lazada_logo.png')

        elif 'Qoo10' in channel:
            logo = modules.get_module_resource('ecapi_mercado_libre', 'static/src/img', 'qoo10_logo.png')

        elif 'Shopee' in channel:
            logo = modules.get_module_resource('ecapi_mercado_libre', 'static/src/img', 'shopee_logo.png')

        elif 'Shopify' in channel:
            logo = modules.get_module_resource('ecapi_mercado_libre', 'static/src/img', 'shopify_logo.png')
            ...
            logo = modules.get_module_resource('ecapi_mercado_libre', 'static/src/img', 'prestashop_logo.png')
...
class OmnaIntegrationChannel(models.Model):
    ...
    def _get_logo(self, group):
        if group == 'Lazada':
            logo = '/ecapi_mercado_libre/static/src/img/lazada_logo.png'
        elif group == 'Qoo10':
            logo = '/ecapi_mercado_libre/static/src/img/qoo10_logo.png'
        elif group == 'Shopee':
            logo = '/ecapi_mercado_libre/static/src/img/shopee_logo.png'
        elif group == 'Shopify':
            logo = '/ecapi_mercado_libre/static/src/img/shopify_logo.png'
        elif group == 'MercadoLibre':
            logo = '/ecapi_mercado_libre/static/src/img/mercadolibre_logo.png'
        elif group == 'Prestashop':
            logo = '/ecapi_mercado_libre/static/src/img/prestashop.png'
        else:
